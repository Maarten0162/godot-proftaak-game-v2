...
public partial class Main : Node2D
{
	...
	public override void _Ready()
	{
		...
		// Get all the spaces (Marker2D nodes) and add them to the list
		for (int i = 1; i <= spacesAmount; i++)
		{
			spaces.Add(GetNode<Node2D>($"spaces/Marker2D{i}")); // Assumes spaces are named "Marker2D_1", "Marker2D_2", etc.
		}
	}
